...
\name{Marcel}{Bajdel}
\address{Frankfurter Strasse 2, 64293, Darmstadt, Germany}
\mobile{+4917641526879}

\email{mbajdel@gmail.com}
\github{Mrcl3}
\linkedin{marcel-bajdel-917197142/}
...
\position{PhD Candidate{\enskip\cdotp\enskip}Nuclear Physicist} % Your expertise/fields

\makecvfooter{\today}{Marcel Bajdel~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed

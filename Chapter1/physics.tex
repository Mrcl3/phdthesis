...
Heavy-ion collisions at beam energies between \agev{2} and \agev{11} have an enormous potential to explore many aspects of the phase diagram. Figure \ref{fig:cbm_density} represents the time evolution of a Au+Au collision system at \agev{10} beam energy. Similar densities as those produced in heavy-ion collisions are expected to prevail during the supernovae core collapse and in the core of neutron stars. Furthermore, the calculations of different transport models and hydrodynamics show that the density of the fireball will reach more than $8\rho_{0}$ during the Au+Au collisions at \agev{10}~\cite{CBM_physics}.

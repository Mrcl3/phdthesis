...
\begin{itemize}
    ...
    \item hit rates and readout - the hit rates of charged particles for the inner-most silicon sensors (\mhz{10} interactions per $\mathrm{cm^{2}}$ define the requirements for the readout system (signal shaping time, number of readout channels etc.)
\end{itemize}

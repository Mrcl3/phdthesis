...
Containers are a handy tool to easily address the control and monitoring of different setups. Still, implementing an additional layer over EPICS-based applications may lead to safety concerns. This technology has many advantages:
\begin{itemize}

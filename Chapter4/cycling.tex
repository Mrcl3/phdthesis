...
%The passive cycling is illustrated in the figure~\ref{fig_passive_cycling}.
...
\end{itemize}
The figure~\ref{fig_power_cycle} shows how the current drawn by the 1.2 \gls{LDO} regulators and 1.8 \gls{LDO} regulators changes with regards to the different tests performed in the STS-XYTERs. The highest current values are reached during write/read tests of the registers. The drop of the currents is related to the change in the \gls{CSA} value. 
\begin{figure}[!h]
\centering

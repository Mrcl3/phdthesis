...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.57\columnwidth]{Chapter4/images/neutrons_dose_rate.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.57\columnwidth]{Chapter4/images/HV_failure_and_neutronrate.png}
    \caption{Cumulative neutron dose and failures of the high voltage module's channels}
    \label{fig:hv_neutrons}
\end{figure}
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.57\columnwidth]{Chapter4/images/Hv_neutrons_dose_rate.png}

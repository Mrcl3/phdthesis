...
\newcommand{\myTitleStyle}[1]{{\huge\color{auburn} #1}}
...
% The AGEV unit
\newcommand{\agev}[1]{\SI{#1}{A\giga\electronvolt}}
% The GEV unit
...
% momentum gev/c
\newcommand{\agevc}[1]{\SI{#1}{\giga\electronvolt/c}}
% momentum gev/c
\newcommand{\gevc}[1]{\SI{#1}{\giga\electronvolt/c}}
% mikro metr
\newcommand{\mum}[1]{\SI{#1}{\micro\metre}}
% kilo gray
\newcommand{\kgy}[1]{\SI{#1}{\kilo\gray}}
% mili gray
\newcommand{\mgy}[1]{\SI{#1}{\milli\gray}}
% new units ions
\DeclareSIUnit\ions{ions}
%\newcommand{\ionss}[1]{\SI{#1}{\ions/\second}}
\newcommand{\ionss}{\unit{\ions/\second}}
